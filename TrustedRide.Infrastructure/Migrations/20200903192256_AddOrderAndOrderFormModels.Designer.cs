...
namespace TrustedRide.Infrastructure.Migrations
{
    ...
    [Migration("20200903192256_AddOrderAndOrderFormModels")]
    partial class AddOrderAndOrderFormModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.DealerCartItem", b =>
                {
                    b.Property<int>("DealerCartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("DealerCartId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Quantity")
                        .HasColumnType("int");

                    b.HasKey("DealerCartItemId");

                    b.HasIndex("CarId");

                    b.ToTable("DealerCartItems");
                });

            modelBuilder.Entity("TrustedRide.Domain.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.Car", b =>
                {
                    b.HasOne("TrustedRide.Domain.Models.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.DealerCartItem", b =>
                {
                    b.HasOne("TrustedRide.Domain.Models.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId");
                });
            ...
            modelBuilder.Entity("TrustedRide.Domain.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("TrustedRide.Domain.Models.Order", "Order")
